...
<template>
    ...
    <AuthenticatedLayout>
                ...
                <div class="grid grid-cols-12 gap-5">
                    ...
                    <div class="col-span-full">
                        ...
                        <label class="flex items-center">
                            <Checkbox id="role" v-model:checked="form.is_admin" />
                            <span class="ms-2 text-sm text-gray-600">Is Administrator?</span>
                        </label>
            ...
            <form @submit.prevent="submitProfile">
                <div class="grid grid-cols-12 gap-5">
                    ...
                    <div class="col-span-full">
                        <InputLabel for="role" value="Role" :required="false" />
                        <label class="flex items-center">
                            <Checkbox id="role" v-model:checked="profileForm.is_admin" />
                            <span class="ms-2 text-sm text-gray-600">Is Administrator?</span>
                        </label>
                        <InputError :message="profileForm.errors.is_admin" class="mt-2" />
                    </div>
                </div>
        ...
        <!-- password form modal -->
        <Modal :show="passwordFormModal" :closeable="true" :modalTitle="this.action + ' user'" @close="hidePasswordFormModal"
            :maxWidth="'md'">
