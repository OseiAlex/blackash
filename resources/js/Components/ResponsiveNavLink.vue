...
const classes = computed(() =>
    props.active
        ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-gray-800 text-left text-base font-medium bg-gray-100 focus:outline-none focus:text-black focus:bg-gray-100 focus:border-gray-800 transition duration-150 ease-in-out'
